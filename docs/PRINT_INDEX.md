...
Print these before show time:

1. [`sheets/minimal-preflight.md`](../sheets/minimal-preflight.md)
1. [`sheets/minimal-controller-map.md`](../sheets/minimal-controller-map.md)
1. [`sheets/minimal-audio-patch.md`](../sheets/minimal-audio-patch.md)
1. [`sheets/failover-card.md`](../sheets/failover-card.md)
