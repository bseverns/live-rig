...
This page is the source shelf for equipment facts. Use equipment pages for operational summaries; use these sources when exact behavior matters.

## Manuals in `notes/manuals/`

| Source | Equipment pages | Notes |
|--------|-----------------|-------|
| `notes/manuals/drumkid-master/` | [DrumKid](AUDIO/drumkid.md) | Public reference bundle and manual material. |
| `notes/manuals/DR-550_OM.pdf` | [DR550](AUDIO/dr550.md) | Owner manual. |
| `notes/manuals/dr550_drrhytm.pdf` | [DR550](AUDIO/dr550.md) | Additional DR-550 reference. |
| `notes/manuals/electribe_sampler.pdf` | [Electribe E2S](AUDIO/electribe-e2s.md) | User manual. |
| `notes/manuals/electribe_sampler_PG.pdf` | [Electribe E2S](AUDIO/electribe-e2s.md) | Parameter guide. |
| `notes/manuals/electribe_sampler_MIDIimp.txt` | [Electribe E2S](AUDIO/electribe-e2s.md) | MIDI implementation notes. |
| `notes/manuals/S900ownersmanual_text.pdf` | [Akai S900](AUDIO/s900.md) | Owner manual text. |
| `notes/manuals/sq64.pdf` | [SQ-64](CONTROL/sq64.md) | Quick/manual reference. |
| `notes/manuals/sq64_full.pdf` | [SQ-64](CONTROL/sq64.md) | Full manual. |
| `notes/manuals/pcr30QS.pdf` | [Edirol PCM-30](CONTROL/edirol-pcm30.md) | Quick-start reference. |
...
| Source | Equipment pages | Notes |
|--------|-----------------|-------|
| `vendor/greyBox/` | [greyBox / Growser family](CUSTOM/greybox.md) | Local snapshot of custom sketches. |

## Diagrams and field notes

| Source | Use |
|--------|-----|
| `RigMap.drawio.png` | Current visual inventory and patch clues. |
| `12_current-studio-rig.md` | Current studio truth. |
| `13_hardware-registry.md` | Canonical device registry. |
| `14_external-sources.md` | Provenance and external source rules. |
| `snapshots/` | Last-known-good or documented-placeholder state. |
